...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="{{ asset('assets-admin/images/logo.png') }}" />
            ...
            <div class="d-flex align-items-center justify-content-center w-100">
                <div class="card auth-card mb-0 mx-3">
                    <div class="card-body">
                        ...
                        <p class="text-center">Login Edudiction</p>
                        <form>
                            <div class="mb-3">
                            ...
                            <a href="./index.html" class="btn btn-primary w-100 fs-4 mb-4">Sign In</a>
